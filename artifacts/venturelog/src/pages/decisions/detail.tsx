...
import { ArrowLeft, Loader2, MessageSquare, Send, Archive, Trash2, CheckCircle2 } from "lucide-react";
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <Badge variant={decision.status === 'open' ? 'default' : 'secondary'} 
              className={decision.status === 'open' ? 'bg-orange-100 text-orange-700 hover:bg-orange-100 shadow-none' : 'shadow-none'}
